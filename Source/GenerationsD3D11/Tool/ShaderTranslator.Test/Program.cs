...
foreach (var archiveFilePath in filePaths)
{
...
using (var stream = File.Create(@"D:\Steam\steamapps\common\Sonic Generations\mods\Direct3D 11\pregenerated_shader_cache.bin"))
using (var writer = new BinaryWriter(stream))
{
